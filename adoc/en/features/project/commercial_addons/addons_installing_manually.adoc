...
--
Use this way of commercial add-on installation if you have any problems with automatic installation, or if you need to build your project from command line (e.g. in continious integration server).
...
--
Open `build.gradle` file and add one more repository *as last repository in the list*:
