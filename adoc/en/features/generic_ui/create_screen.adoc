...
The *Entity browser view* and *Entity editor view* wizard steps allow you to select amount of data that will be displayed in the browser table or edited in the entity editor form. Selected properties also determine the <<data_model_view,entity view>> used to load entities to the screen:

image::features/generic_ui/create_screen_view_step.png[align="center"]
...
include::create_screen/custom_screen_templates.adoc[]
